...
// POST /api/login
// simple login with fixed creds: Z2A / 1234
...
// fallback to serve files (static)
app.get('*', (req,res)=>{
  // if requesting /admin serve admin.html else index.html
